...
if rtconfig.PLATFORM in ['gcc']:
    start_src += [cwd + '/cmsis/Device/HDSC/hc32f4xx/Source/GCC/startup_hc32f460.S']
elif rtconfig.PLATFORM in ['armcc', 'armclang']:
    start_src += [cwd + '/cmsis/Device/HDSC/hc32f4xx/Source/ARM/startup_hc32f460.s']
elif rtconfig.PLATFORM in ['iccarm']:
    start_src += [cwd + '/cmsis/Device/HDSC/hc32f4xx/Source/IAR/startup_hc32f460.s']
